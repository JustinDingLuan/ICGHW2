...
bool TriangleMesh::LoadMaterial(std::string filePath ,std::string filename) {
...
{	
	...
	string Path = "ICG2022_HW2_Test_Models/" + filename + "/" + filePath;		
...
void TriangleMesh::ShowInfo()
{
	...
	cout << "Total " << subMeshes.size() << " subMeshes loaded" << std::endl;
	
	for (unsigned int i = 0; i < subMeshes.size(); ++i) {
		SubMesh& g = subMeshes[i];
